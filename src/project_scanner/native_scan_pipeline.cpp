...
void ScanRepository::complete_scan_run(
    ...
    Statement insert_metrics = database_->prepare(R"sql(
        INSERT INTO scan_metrics (
            ...
            sqlite_parent_resolve_ms, sqlite_parse_status_ms, sqlite_custom_class_ms, sqlite_tombstone_ms,
            sqlite_deleted_reconcile_ms, sqlite_metrics_write_ms,
            ...
            scripts_candidates, scripts_parsed, scripts_skipped_clean, script_lines_scanned,
            bytes_read, entry_record_count, path_arena_bytes, existing_snapshot_count, parsed_script_count,
    ...
    insert_metrics.bind_int64(13, metrics.sqlite_write_ms);
    insert_metrics.bind_int64(14, metrics.sqlite_stage_insert_ms);
    insert_metrics.bind_int64(15, metrics.sqlite_file_merge_ms);
    insert_metrics.bind_int64(16, metrics.sqlite_clean_refresh_ms);
    insert_metrics.bind_int64(17, metrics.sqlite_parent_resolve_ms);
    insert_metrics.bind_int64(18, metrics.sqlite_parse_status_ms);
    insert_metrics.bind_int64(19, metrics.sqlite_custom_class_ms);
    insert_metrics.bind_int64(20, metrics.sqlite_tombstone_ms);
    insert_metrics.bind_int64(21, metrics.sqlite_deleted_reconcile_ms);
    insert_metrics.bind_int64(22, metrics.sqlite_metrics_write_ms);
    insert_metrics.bind_int64(23, metrics.godot_materialization_ms);
    insert_metrics.bind_int64(24, metrics.files_seen);
    insert_metrics.bind_int64(25, metrics.dirs_seen);
    insert_metrics.bind_int64(26, metrics.dirs_skipped);
    insert_metrics.bind_int64(27, metrics.entries_clean);
    insert_metrics.bind_int64(28, metrics.entries_dirty);
    insert_metrics.bind_int64(29, metrics.entries_new);
    insert_metrics.bind_int64(30, metrics.entries_deleted);
    insert_metrics.bind_int64(31, metrics.rows_inserted);
    insert_metrics.bind_int64(32, metrics.rows_updated);
    insert_metrics.bind_int64(33, metrics.rows_clean_refreshed);
    insert_metrics.bind_int64(34, metrics.rows_tombstoned);
    insert_metrics.bind_int64(35, metrics.scripts_candidates);
    insert_metrics.bind_int64(36, metrics.scripts_parsed);
    insert_metrics.bind_int64(37, metrics.scripts_skipped_clean);
    insert_metrics.bind_int64(38, metrics.script_lines_scanned);
    insert_metrics.bind_int64(39, metrics.bytes_read);
    insert_metrics.bind_int64(40, metrics.entry_record_count);
    insert_metrics.bind_int64(41, metrics.path_arena_bytes);
    insert_metrics.bind_int64(42, metrics.existing_snapshot_count);
    insert_metrics.bind_int64(43, metrics.parsed_script_count);
    insert_metrics.bind_int64(44, metrics.sqlite_statement_steps);
    insert_metrics.bind_int64(45, metrics.sqlite_transactions);
    insert_metrics.bind_int64(46, metrics.ui_rows_materialized);
    insert_metrics.bind_int64(47, metrics.cancellation_requested ? 1 : 0);
    insert_metrics.bind_text(48, metrics.scan_result_status);
    insert_metrics.bind_int64(49, finished_at_unix);
...
void ScanRepository::write_scan_results(
    ...
    for (size_t i = 0; i < records.size(); ++i) {
        ...
        insert_stage.bind_int64(20, CLASSIFIER_VERSION);
...
ScanMetrics ScanRepository::get_scan_metrics(int64_t project_id, int64_t scan_run_id) const {
    ...
    metrics.sqlite_write_ms = statement.column_int64(9);
    metrics.sqlite_stage_insert_ms = statement.column_int64(10);
    metrics.sqlite_file_merge_ms = statement.column_int64(11);
    metrics.sqlite_clean_refresh_ms = statement.column_int64(12);
    metrics.sqlite_parent_resolve_ms = statement.column_int64(13);
    metrics.sqlite_parse_status_ms = statement.column_int64(14);
    metrics.sqlite_custom_class_ms = statement.column_int64(15);
    metrics.sqlite_tombstone_ms = statement.column_int64(16);
    metrics.sqlite_deleted_reconcile_ms = statement.column_int64(17);
    metrics.sqlite_metrics_write_ms = statement.column_int64(18);
    metrics.godot_materialization_ms = statement.column_int64(19);
    metrics.files_seen = statement.column_int64(20);
    metrics.dirs_seen = statement.column_int64(21);
    metrics.dirs_skipped = statement.column_int64(22);
    metrics.entries_clean = statement.column_int64(23);
    metrics.entries_dirty = statement.column_int64(24);
    metrics.entries_new = statement.column_int64(25);
    metrics.entries_deleted = statement.column_int64(26);
    metrics.rows_inserted = statement.column_int64(27);
    metrics.rows_updated = statement.column_int64(28);
    metrics.rows_clean_refreshed = statement.column_int64(29);
    metrics.rows_tombstoned = statement.column_int64(30);
    metrics.scripts_candidates = statement.column_int64(31);
    metrics.scripts_parsed = statement.column_int64(32);
    metrics.scripts_skipped_clean = statement.column_int64(33);
    metrics.script_lines_scanned = statement.column_int64(34);
    metrics.bytes_read = statement.column_int64(35);
    metrics.entry_record_count = statement.column_int64(36);
    metrics.path_arena_bytes = statement.column_int64(37);
    metrics.existing_snapshot_count = statement.column_int64(38);
    metrics.parsed_script_count = statement.column_int64(39);
    metrics.sqlite_statement_steps = statement.column_int64(40);
    metrics.sqlite_transactions = statement.column_int64(41);
    metrics.ui_rows_materialized = statement.column_int64(42);
    metrics.cancellation_requested = statement.column_int64(43) != 0;
    metrics.scan_result_status = statement.column_text(44);
    return metrics;
}
